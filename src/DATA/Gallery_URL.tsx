...
export const FRANCE_images: ImageInfoPairsType[] = [
    {
        ...
        title: "On the Montmartre Hill",
        subtitle: "Sacré-Cœur, colline de montmartre",
        description: "AM 09:30. Quiet morning on Montmartre Hill, in front of the Basilique du Sacré-Cœur. A panoramic view of Paris unfolds below.",
        location: "https://www.google.com/maps/place/Sacr%C3%A9-C%C5%93ur/",
    },
    { 
        url: GALLERY_ROOT + "FRANCE/20230117_Paris2.jpg",
        title: "Ober Mamma",
        description: "PM 18:30. The truffle pasta was excellent.",
        location: "https://www.google.co.kr/maps/place/Ober+Mamma/",
    },
    {
        url: GALLERY_ROOT + "FRANCE/20230118_Paris3.jpg",
        title: "Musée d'Orsay",
        description: "PM 13:15. Exterior view of the Musée d'Orsay, including its iconic clock.",
    },
    { 
        url: GALLERY_ROOT + "FRANCE/20230118_Paris4.jpg",
        title: "Walking around the Louvre",
        subtitle: "Musée du Louvre",
        description: "PM 13:20. Exterior view of the Musée du Louvre.",
    },
    { 
        url: GALLERY_ROOT + "FRANCE/20230118_Paris5.jpg",
        title: "Inside the Louvre",
        subtitle: "Musée du Louvre",
        description: "PM 15:10. The iconic glass pyramid and the Louvre Museum.",
    },
    {
        url: GALLERY_ROOT + "FRANCE/20230119_Paris6.jpg",
        title: "Sainte-Chapelle",
        subtitle: "Sainte-Chapelle",
        description: "AM 10:40. The harmonious stained glass windows create a fantastic view.",
    },
    { 
        url: GALLERY_ROOT + "FRANCE/20230119_Paris7.jpg",
        title: "Sainte-Chapelle (2)",
        subtitle: "Sainte-Chapelle",
        description: "AM 11:00. The harmonious stained glass windows create a fantastic view.",
    },
    {
        url: GALLERY_ROOT + "FRANCE/20230120_Paris8.jpg",
        title: "Étoile",
        subtitle: "Arc de Triomphe",
        description: "AM 10:00. Quiet morning on the Étoile, in front of the Arc de Triomphe.",
    },
    { 
        url: GALLERY_ROOT + "FRANCE/20230120_Paris9.jpg",
        title: "Étoile Observatory",
    ...
    { 
        ...
        description: "PM 16:40. The Grand Foyer.",
    },
    { 
        url: GALLERY_ROOT + "FRANCE/20230122_Paris13.jpg",
        title: "Montparnasse 56th floor",
        subtitle: "Montparnasse 56th floor",
